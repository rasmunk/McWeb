...
class McStaticDataBrowserGenerator():
    ...
    def generate_browsepage(self, data_folder, plot_files, dat_files, skip_visualisation):
    ...
    def generate_browsepage_sweep(self, data_folder, plot_files, dat_files, scanpoints, skip_visualisation):
